...
class VariantUpdatePage extends SaveBasePage {
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslation(['variantUpdatePage','listBasePage'])(VariantUpdatePage));