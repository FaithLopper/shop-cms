...
const { CATEGORY_KIND_DEPARTMENTS } = categoryKinds;

class CategoryDepartmentsListPage extends ListBasePage {
  initialSearch() {
  ...
  constructor(props) {
    ...
    this.objectListName = "category-departments";
  ...
  prepareCreateData(data) {
    return {
      ...data,
      categoryKind: CATEGORY_KIND_DEPARTMENTS,
    };
  }
  ...
  getList() {
    ...
    const params = {
      ...
      search: this.search,
      kind: CATEGORY_KIND_DEPARTMENTS,
    };
    getDataList({ params });
  }
